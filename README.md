...
-   **Web UI**: A clean, modern web interface to visualize events and manage ABIs.
...
-   **Repositories** (`src/repositories`): Handle data access (e.g., `AbiRepository`, `LogRepository`).
